...
namespace Backend_Riwi_LinkUp.Seeders
{
    ...
    public class UserSeeder
    {
        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            var users = new[]
            {
        new { Id = 1, Name = "jackeline cardona", Email = "jackeline.cardona@example.com", PhoneNumber = "1234567890", CreatedAt = new DateTime(2024, 5, 1, 1, 17, 51, DateTimeKind.Utc), SectorId = 1, RoleId = 1 },
        new { Id = 2, Name = "jane smith", Email = "jane.smith@example.com", PhoneNumber = "2345678901", CreatedAt = new DateTime(2024, 7, 10, 1, 17, 51, DateTimeKind.Utc), SectorId = 2, RoleId = 2 },
        new { Id = 3, Name = "alice johnson", Email = "alice.johnson@example.com", PhoneNumber = "3456789012", CreatedAt = new DateTime(2024, 7, 20, 1, 17, 51, DateTimeKind.Utc), SectorId = 4, RoleId = 2 },
        new { Id = 4, Name = "bob williams", Email = "bob.williams@example.com", PhoneNumber = "4567890123", CreatedAt = new DateTime(2024, 6, 1, 1, 17, 51, DateTimeKind.Utc), SectorId = 3, RoleId = 2 },
        new { Id = 5, Name = "charlie brown", Email = "charlie.brown@example.com", PhoneNumber = "5678901234", CreatedAt = new DateTime(2024, 5, 15, 1, 17, 51, DateTimeKind.Utc), SectorId = 2, RoleId = 2 },
        new { Id = 6, Name = "diana clark", Email = "diana.clark@example.com", PhoneNumber = "6789012345", CreatedAt = new DateTime(2024, 5, 25, 1, 17, 51, DateTimeKind.Utc), SectorId = 1, RoleId = 2 },
        new { Id = 7, Name = "edward davis", Email = "edward.davis@example.com", PhoneNumber = "7890123456", CreatedAt = new DateTime(2024, 9, 1, 1, 17, 51, DateTimeKind.Utc), SectorId = 5, RoleId = 2 },
        new { Id = 8, Name = "fiona evans", Email = "fiona.evans@example.com", PhoneNumber = "8901234567", CreatedAt = new DateTime(2024, 6, 10, 1, 17, 51, DateTimeKind.Utc), SectorId = 2, RoleId = 2 },
        ...
        new { Id = 10, Name = "hannah green", Email = "hannah.green@example.com", PhoneNumber = "0123456789", CreatedAt = new DateTime(2024, 5, 1, 1, 17, 51, DateTimeKind.Utc), SectorId = 3, RoleId = 2 },
        new { Id = 11, Name = "isaac lewis", Email = "isaac.lewis@example.com", PhoneNumber = "1234567891", CreatedAt = new DateTime(2024, 8, 10, 1, 17, 51, DateTimeKind.Utc), SectorId = 2, RoleId = 2 },
        ...
        new { Id = 14, Name = "laura johnson", Email = "laura.johnson@example.com", PhoneNumber = "4567890124", CreatedAt = new DateTime(2024, 9, 10, 1, 17, 51, DateTimeKind.Utc), SectorId = 1, RoleId = 2 },
        ...
        new { Id = 16, Name = "natalie moore", Email = "natalie.moore@example.com", PhoneNumber = "6789012346", CreatedAt = new DateTime(2024, 5, 1, 1, 17, 51, DateTimeKind.Utc), SectorId = 4, RoleId = 2 },
